/**
 *  Avisame cuando con franja horaria ...
 *
 ...
 */
definition(
    name: "Avisame Cuando con franja horaria ...",
    namespace: "cursoIoTApplications",
    author: "Monica Pinto",
    description: "Avisa cuando alguien llega pero solo cuando esta en una franja horaria determinada",
    category: "My Apps",
...
private sendMessage(evt) {
    ...
    /** Aunque horaInicio y horaFin están en la hora local, evt.date devuelve la hora UTC.
        ...
        la zona horario pasada como último parámetro **/
    if (timeOfDayIsBetween(horaInicio, horaFin, evt.date, location.timeZone)){ 
